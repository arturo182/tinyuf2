...
SRC_S += $(MFTOP)/hw/chip/$(TUF2_CHIP_FAMILY)/$(TUF2_CHIP_MEMBER)/crt0-vexriscv-rom.S

LD_FILE = -T$(MFTOP)/hw/chip/$(TUF2_CHIP_FAMILY)/$(TUF2_CHIP_MEMBER)/linker-rom.ld  -L$(SOC_DIR)/include -L$(LITEX_DIR)
